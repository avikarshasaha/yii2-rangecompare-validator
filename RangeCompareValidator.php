...
class RangeCompareValidator extends Validator
{
    /**
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        if ($this->skipOnCompareAttributeEmpty) {
            $options['skipOnCompareAttributeEmpty'] = 1;
        }
        ...
        RangeCompareValidatorAsset::register($view);

        return 'yii.validation.rangecompare(value, messages, ' . json_encode($options, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . ');';
    }
}
